...
library.theme = {
    ...
    accentcolor = Color3.fromRGB(148,180,244),
    accentcolor2 = Color3.fromRGB(148,180,244),
...
function library:CreateWindow(name, size, hidebutton)
    ...
    window.hidebutton = Enum.KeyCode.RightShift
    ...
    function window:CreateTab(name)
        ...
        function tab:CreateConfigSystem(side)
            ...
            configSystem.configFolder = window.name .. "/configs"
